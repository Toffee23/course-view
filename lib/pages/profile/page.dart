      ...
      body: SingleChildScrollView(
        child: Column(
          children: <Widget>[
            ...
            const Divider(),
            SettingsListTile(
              onTap: () => onSecurity(context),
              leading: AssetImages.security,
              title: 'Security',
              subtitle: 'Help keeping your data secure',
              isComingSoon: true,
            ),
            SettingsListTile(
              onTap: () => onLanguage(context),
              leading: AssetImages.language,
              title: 'Language',
              subtitle: 'Change to your preferred language',
              isComingSoon: true,
            ),
            SettingsListTile(
